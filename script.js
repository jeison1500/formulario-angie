...
document.getElementById('customerForm').addEventListener('submit', function (e) {
    ...
    const scriptURL = 'https://script.google.com/macros/s/AKfycby6dOe1XcTtWyufeL-yC2QJev3m2bNsvsR4JpVolRSSx-icopZRMQetTnTIwXPwzM9N9w/exec';  // Reemplaza con tu URL de Web App
